...
public abstract class Base
{
    ...
    private void _cleanup()
    {
        ...
        if (_consumers != null)
        {
            ...
            {
                Logger.Info(TAG, $"Disposing consumer for topic #{consumer.GetTopic()}...");
                consumer.Dispose();
            }
        }
    ...
    private async Task HandleIncomingMessage(string rawMessage)
    {
        ...
        try
        {
            ...
            {
                Logger.Info(TAG, "Producing response message...");
                await produceMessage("user", planeResponse);
                Logger.Info(TAG, "Response message produced.");
            }
        }
